...
select * from stab.assocaite_status;
alter table Assocaite_status
add column Batch_Id varchar(20),
add column Trainer_Id varchar(20);
select * from Assocaite_Status;
alter table assocaite_status
...
('A001','J2EE','B004','F004','2005-12-1','2005-12-2'),
...
('A006','ANDRD4','B009','IF005','2011-8-1','2011-8-20');

#2.4(password changing)

use stab;
select * from trainer_info;

update trainer_info set trainer_pasword ='nn4@123' where trainer_id='F004';

#2.5(deleting a particular data)
SELECT * FROM stab.associate_status;
...
#2.7(creating of table login details nd modifying)
